...
### Blue Finch Labs — Product Engineer
**4 years** · 2022–present

- Built and operated the account recovery flow using TypeScript and Python; reduced a recurring operational queue by 34%.
- Owned design, implementation, rollout, and on-call handoff for the account recovery flow.
