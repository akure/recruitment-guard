...
### Cobalt Orchard — Security / Reliability Engineer
**6 years** · 2022–present

- Built and operated the service identity rollout using Go, Terraform, and Python; reduced a recurring operational queue by 34%.
- Owned design, implementation, rollout, and on-call handoff for the service identity rollout.
